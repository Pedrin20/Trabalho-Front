...
export default function CreateAccount({ onLogin, onGoToLogin, onGoToCreateAccount, onGoSobre, onGoHome }) {
        ...
        <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-xl shadow-md mt-8">
          ...
          <div className="text-center">
            <p className="mt-2 text-sm text-gray-600">
              Já tem uma conta?{' '}
              <a href="#" onClick={onGoToLogin} className="font-medium text-indigo-600 hover:text-indigo-500">
                Entrar
              </a>
            </p>
          </div>
